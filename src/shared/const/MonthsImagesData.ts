...
import Oct from '@/shared/assets/images/Oct.png';
import Dec from '@/shared/assets/images/Dec.png';

interface MonthsImagesData {
  month: string;
  image: string;
}

export const monthsImagesData: MonthsImagesData[] = [
  {
    month: 'Jan',
    image: Jan,
  },
